...
csv_path = "D:\Coding\Triage.csv"

def train_triage_model(csv_path, output_model_path="D:/Coding/ai-triage-model/app/models/triage_model.pkl"):
...
# Load model globally
model = joblib.load("D:/Coding/ai-triage-model/app/models/triage_model.pkl")
